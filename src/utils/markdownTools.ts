 ...
 * 添加有序列表
 */
function handleOrderList(cm: any) {
    /**
     * 已经选中文本
     * --- 获取选中的文本和前后光标位置
     * --- 选中了多行文本
 ...
 * 添加引用和无序列表
 */
function handleUnorderedList(cm: any, matchStr: string) {
    /**
     * 已经选中文本
     * --- 获取选中的文本和前后光标位置
     * --- 选中了多行文本
 ...
 */
function handleTitle(cm: any, level: number) {
    /**
     * 已经选中文本
     * --- 获取选中的文本和前后光标位置
     * --- 如果选中了文字，并且起始位置为 0
 ...
 * 判断选中文本的光标是在文本开头还是结尾
 */
function judgePreOrAft(selectInfo: any) {
